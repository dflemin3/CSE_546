...
\begin{figure}[H]
	\includegraphics[width=\columnwidth]{pca_01_loss.pdf}
    \caption{0/1 loss versus epoch for the both the MNIST training and testing sets for both the $w_t$ and $\bar{w}_{\tau}$.}
    \label{fig:pca_01_loss}
\end{figure}
