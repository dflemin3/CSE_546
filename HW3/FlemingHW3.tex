...
In Fig.~\ref{fig:k_16_means}, I visualize the $k = 16$ centers my K-means algorithm learned on the MNIST training set.
...
TODO: $k = 16$ interpretation

\subsection*{5.2: Classification with K-means}

TODO

\subsection*{5.3: Your thoughts?}
