...
Note: My solution for this question is generated using the script {\tt hw1$\_$7.3.py} and other scripts used for this solution are {\tt lasso$\_$utils.py, validation.py \text{ and } regression$\_$utils.py}.
